            ...
            <>
                <div className="bg-gray-100">
                    <div className="container mx-auto py-10">
                        <Statistic />
                        <div className="my-7">
                            <h1 class="title-font sm:text-3xl text-2xl mb-1 font-medium text-gray-900">Member Side</h1>
                            <p class="leading-relaxed text-gray-500">Panel management anggota/pelanggan</p>
                        </div>
