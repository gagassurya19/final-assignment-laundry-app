...
export default class Member extends React.Component {
    ...
    saveData = async (ev) => {
        ...
        if (this.state.action === "add") {
            ...
            const url = process.env.REACT_APP_ADMIN_API_URL + 'admin_customer/' + this.state.id_customer
    ...
    deleteData = (selectedItem) => {
        const url = process.env.REACT_APP_ADMIN_API_URL + 'admin_customer/' + selectedItem.id_customer
                ...
                <div className="bg-gray-100">
                    <div className="container mx-auto py-10">
                        <div class="col-span-1 md:col-span-2 lg:col-span-4 flex justify-between py-7">
                            <div>
                                <h1 class="title-font sm:text-3xl text-2xl mb-1 font-medium text-gray-900">Member Management</h1>
                                <p class="leading-relaxed text-gray-500">Panel management member laundry</p>
                            </div>
                            <div>
                                                                        ...
                                                                        <li class="py-3 sm:py-4">
                                                                            <div class="flex items-center space-x-4">
                                                                                <div class="flex-shrink-0">
                                                                                    <img class="w-8 h-8 rounded-full" src={data.photo_profile ? (process.env.REACT_APP_CUSTOMER_API_IMAGE + data.photo_profile) : (process.env.REACT_APP_CUSTOMER_API_IMAGE + 'default.png')} alt="Photo profile" />
                                                                                </div>
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-6">
                                            ...
                                            <div class="flex flex-wrap justify-center">
                                                    <div class="w-12/12 pb-5">
                                                        <img
                                                            id='img'    
                                                            src={this.state.photo_profile ? (process.env.REACT_APP_CUSTOMER_API_IMAGE + this.state.photo_profile) : (process.env.REACT_APP_CUSTOMER_API_IMAGE + 'default.png')}
                                                            alt="Photo profile"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" name="last_name" id="last_name" autocomplete="family-name" class="border p-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" 
