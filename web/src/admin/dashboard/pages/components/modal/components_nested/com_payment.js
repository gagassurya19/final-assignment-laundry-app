...
export default class Payment extends React.Component {
    ...
    // get data payment customer by id customer
    getDataPayment = async () => {
        ...
        await axios.get(url, {
            ...
            .then(result => {
                this.setState({
                    data_payment_customer: result.data.data_payment_customer
                })
            })
            .catch(error => console.log(error))
    }
    ...
    render() {
        return (
            <>
                {/* Button */}
                {this.state.data_payment_customer.map((data, index) => (
