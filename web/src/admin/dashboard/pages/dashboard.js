...
import dish from '../../../assets/image/dashboard-admin/dish.png';
import gaming from '../../../assets/image/dashboard-admin/gaming.png';
import holiday from '../../../assets/image/dashboard-admin/holiday.png';
import grocery from '../../../assets/image/dashboard-admin/grocery.png';
                    ...
                    <div class="bg-white p-6 rounded-xl border border-gray-50">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="bg-blue-500 p-2 md:p-1 xl:p-2 rounded-md">
                                <img src={dish} alt="icon" class="w-auto h-8 md:h-6 xl:h-8 object-cover" />
                            </div>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-xl border border-gray-50">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="bg-green-500 p-2 md:p-1 xl:p-2 rounded-md">
                                <img src={grocery} alt="icon" class="w-auto h-8 md:h-6 xl:h-8 object-cover" />
                            </div>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-xl border border-gray-50">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="bg-yellow-500 p-2 md:p-1 xl:p-2 rounded-md">
                                <img src={gaming} alt="icon" class="w-auto h-8 md:h-6 xl:h-8 object-cover" />
                            </div>
                        </div>
                    </div>
                    <div class="bg-white p-6 rounded-xl border border-gray-50">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="bg-indigo-500 p-2 md:p-1 xl:p-2 rounded-md">
                                <img src={holiday} alt="icon" class="w-auto h-8 md:h-6 xl:h-8 object-cover" />
                            </div>
                        </div>
                    </div>
                </div>
